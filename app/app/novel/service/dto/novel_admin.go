...
type NovelUserQueryReq struct {
	...
	Status         string `form:"status" search:"type:exact;column:status;table:app_user" comment:"状态 1-正常 2-异常"`
}
...
type NovelUserItem struct {
	...
	Status   string `json:"status" gorm:"column:status" comment:"状态 1-正常 2-异常"`
	Mobile   string `json:"mobile" gorm:"column:mobile" comment:"手机号码"`
}

// NovelUserStatusReq 启用/禁用读者请求
...
// NovelPostAdminQueryReq 后台帖子分页查询
...
// NovelPostAdminStatusReq 后台帖子状态变更请求
