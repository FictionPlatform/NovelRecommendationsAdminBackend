...
INSERT INTO "public"."admin_sys_config" ("id", "config_name", "config_key", "config_value", "config_type", "is_frontend", "remark", "create_by", "update_by", "created_at", "updated_at") VALUES (3, '管理-侧栏主题', 'admin_sys_index_sideTheme', 'theme-dark', '1', '1', '主框架页-侧边栏主�?深色主题theme-dark，浅色主题theme-light', 1, 1, '2021-05-13 19:56:38', '2023-03-11 23:16:06');
...
COMMENT ON COLUMN "public"."admin_sys_dept"."status" IS '状�?1-正常 2-异常';
...
COMMENT ON COLUMN "public"."admin_sys_dict_data"."status" IS '状�?1-正常 2-异常';
...
COMMENT ON COLUMN "public"."admin_sys_gen_table"."is_plugin" IS '是否插件 1-�?2-�?;
...
COMMENT ON COLUMN "public"."admin_sys_login_log"."status" IS '状�?1-登录 2-退�?;
...
-- 登录日志按用户查�?统计主路�?CREATE INDEX "idx_admin_sys_login_log_user_id_created_at" ON "public"."admin_sys_login_log" USING btree ("user_id", "created_at");
...
COMMENT ON COLUMN "public"."admin_sys_menu"."is_keep_alive" IS '是否缓存 1-�?2-�?;
COMMENT ON COLUMN "public"."admin_sys_menu"."is_affix" IS '是否固定 1-�?2-�?;
COMMENT ON COLUMN "public"."admin_sys_menu"."is_hidden" IS '是否隐藏 1-�?2-�?;
COMMENT ON COLUMN "public"."admin_sys_menu"."is_frame" IS '是否内嵌 1-�?2-�?;
...
-- 操作日志按用户查�?统计主路�?CREATE INDEX "idx_admin_sys_oper_log_user_id_created_at" ON "public"."admin_sys_oper_log" USING btree ("user_id", "created_at");
...
COMMENT ON COLUMN "public"."admin_sys_post"."status" IS '状�?1-正常 2-异常';
...
COMMENT ON COLUMN "public"."admin_sys_role"."status" IS '状�?1-正常 2-停用';
...
COMMENT ON COLUMN "public"."admin_sys_user"."status" IS '状�?1-正常 2-异常';
...
-- 用户名唯一，避免重复导致登�?First() 行为不确�?CREATE UNIQUE INDEX "uniq_admin_sys_user_username" ON "public"."admin_sys_user" USING btree ("username");
...
COMMENT ON COLUMN "public"."app_user"."status" IS '状�?1-正常 2-异常)';
...
-- 账变记录按用户查询是主路径，user_id 必须建索�?CREATE INDEX "idx_app_user_account_log_user_id" ON "public"."app_user_account_log" USING btree ("user_id");
...
COMMENT ON COLUMN "public"."app_user_conf"."can_login" IS '1-允许登陆�?-不允许登�?;
...
COMMENT ON COLUMN "public"."app_user_country_code"."status" IS '状�?1-可用 2-停用)';
...
COMMENT ON COLUMN "public"."app_user_level"."status" IS '状�?1-正常 2-异常)';
...
COMMENT ON COLUMN "public"."app_user_oper_log"."status" IS '状�?1-正常 2-异常)';
...
COMMENT ON COLUMN "public"."plugins_msg_code"."code_type" IS '验证码类�?1-邮箱�?-短信';
COMMENT ON COLUMN "public"."plugins_msg_code"."remark" IS '备注异常';
COMMENT ON COLUMN "public"."plugins_msg_code"."status" IS '验证码状�?1-发送成�?2-发送失�?;
